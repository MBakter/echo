...
@echo off
set "diffFile=./diff_output/test21_diff.txt"
set "inFile=../test_txt/test_input/test21.txt"
set "outFile=../test_txt/test_output/test21_out.txt"
set "expectedFile=../test_txt/test_expected/test21_exp.txt"
