...
@echo off
set "diffFile=./diff_output/test17_diff.txt"
set "inFile=../test_txt/test_input/test17.txt"
set "outFile=../test_txt/test_output/test17_out.txt"
set "expectedFile=../test_txt/test_expected/test17_exp.txt"
