...
@echo off
set "diffFile=./diff_output/test15_diff.txt"
set "inFile=../test_txt/test_input/test15.txt"
set "outFile=../test_txt/test_output/test15_out.txt"
set "expectedFile=../test_txt/test_expected/test15_exp.txt"
