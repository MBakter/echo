...
@echo off
set "diffFile=./diff_output/test7_diff.txt"
set "inFile=../test_txt/test_input/test7.txt"
set "outFile=../test_txt/test_output/test7_out.txt"
set "expectedFile=../test_txt/test_expected/test7_exp.txt"
