...
@echo off
set "diffFile=./diff_output/test22_diff.txt"
set "inFile=../test_txt/test_input/test22.txt"
set "outFile=../test_txt/test_output/test22_out.txt"
set "expectedFile=../test_txt/test_expected/test22_exp.txt"
