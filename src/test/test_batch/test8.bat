...
@echo off
set "diffFile=./diff_output/test8_diff.txt"
set "inFile=../test_txt/test_input/test8.txt"
set "outFile=../test_txt/test_output/test8_out.txt"
set "expectedFile=../test_txt/test_expected/test8_exp.txt"
