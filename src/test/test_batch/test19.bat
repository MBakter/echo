...
@echo off
set "diffFile=./diff_output/test19_diff.txt"
set "inFile=../test_txt/test_input/test19.txt"
set "outFile=../test_txt/test_output/test19_out.txt"
set "expectedFile=../test_txt/test_expected/test19_exp.txt"
