...
@echo off
set "diffFile=./diff_output/test3_diff.txt"
set "inFile=../test_txt/test_input/test3.txt"
set "outFile=../test_txt/test_output/test3_out.txt"
set "expectedFile=../test_txt/test_expected/test3_exp.txt"
