...
@echo off
set "diffFile=./diff_output/test9_diff.txt"
set "inFile=../test_txt/test_input/test9.txt"
set "outFile=../test_txt/test_output/test9_out.txt"
set "expectedFile=../test_txt/test_expected/test9_exp.txt"
