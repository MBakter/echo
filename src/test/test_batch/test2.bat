...
@echo off
set "diffFile=./diff_output/test2_diff.txt"
set "inFile=../test_txt/test_input/test2.txt"
set "outFile=../test_txt/test_output/test2_out.txt"
set "expectedFile=../test_txt/test_expected/test2_exp.txt"
