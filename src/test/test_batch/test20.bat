...
@echo off
set "diffFile=./diff_output/test20_diff.txt"
set "inFile=../test_txt/test_input/test20.txt"
set "outFile=../test_txt/test_output/test20_out.txt"
set "expectedFile=../test_txt/test_expected/test20_exp.txt"
