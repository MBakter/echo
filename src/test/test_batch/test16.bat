...
@echo off
set "diffFile=./diff_output/test16_diff.txt"
set "inFile=../test_txt/test_input/test16.txt"
set "outFile=../test_txt/test_output/test16_out.txt"
set "expectedFile=../test_txt/test_expected/test16_exp.txt"
