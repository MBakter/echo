...
@echo off
set "diffFile=./diff_output/test14_diff.txt"
set "inFile=../test_txt/test_input/test14.txt"
set "outFile=../test_txt/test_output/test14_out.txt"
set "expectedFile=../test_txt/test_expected/test14_exp.txt"
